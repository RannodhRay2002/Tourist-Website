...
*/
// ------------------------Activities Page ticket booking-------------------------------//
//--------------------------------------------------------------------------------//
...
document.getElementById("AddOrder").onclick = function(){
  ...
  if(ticketApp.no_of_adults>0 || ticketApp.no_of_children>0){
    ...
    td7.innerHTML = "<a href='javascript:void(0)' style='color:red;font-weight:bold' onclick='removeRecord(this.parentElement);'> <img src ='images/trash-bin.png' id ='trshBin' alt ='trashbin' > </a>";
